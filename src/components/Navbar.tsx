          ...
          <Show when="signed-out">
            <div className="flex items-center gap-2.5">
              <SignInButton mode="modal">
                <button className="text-xs sm:text-sm px-3 py-1.5 text-[hsl(40,20%,90%)] hover:text-[hsl(42,95%,55%)] transition-colors font-[family-name:var(--font-inter)] cursor-pointer">
                  Sign in
                </button>
              </SignInButton>
