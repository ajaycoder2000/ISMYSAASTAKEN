...
export function WhyValidationMattersSection() {
  ...
  return (
    <section className="w-full py-12 sm:py-20 max-w-3xl mx-auto px-2 sm:px-4">
      ...
      {/* 1. Heading */}
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-[family-name:var(--font-space-grotesk)] text-[var(--text-primary)] text-center tracking-tight leading-snug mb-3">
        Why idea validation matters
      </h2>

      {/* 2. Subhead */}
      <p className="text-xs sm:text-sm text-[var(--text-secondary)] font-[family-name:var(--font-inter)] text-center mb-8 sm:mb-10 max-w-xl mx-auto leading-relaxed">
      ...
      <div className="text-center mt-8 sm:mt-10">
        <a
          ...
          className="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-[var(--accent-amber)] hover:opacity-90 text-black text-button font-[family-name:var(--font-space-grotesk)] font-bold transition-all shadow-lg shadow-[rgba(245,166,35,0.15)] hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
        >
